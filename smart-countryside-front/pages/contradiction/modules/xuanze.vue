    ...
    >
      <view class="selectContent">
        ...
        >
          ...
          >
            <!-- <view class="itemName" :class="type == 'taskState' ? 'bg' : ''">{{item.category}}</view> -->
            <view class="itemName">{{ item.category||item.title }}</view>
            <view
              class="itemCheck"
              v-if="item.show"
            >
...
export default {
  ...
  methods: {
    ...
    searchVal(n) {
      ...
      // this.data = this.data.filter((item) => item.category.includes(n));

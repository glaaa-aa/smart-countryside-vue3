<template>
  <div class='ruralActivity'>
    <!-- 导航栏 -->
    <!-- <navigation title="我参与的"></navigation> -->
    <!-- 活动列表 -->
    <ruralList :dataList="dataList"></ruralList>
  </div>
</template>
<script>
import navigation from "@/components/navigation/navigation";
import { getImgUrl } from "@/common/utils.js";
import ruralList from './ruralList.vue'
  ...
  methods: {
    ...
    getData(current) {
      this.dataList = [
        ...
        { id: 2, num: '2023/10/12 星期四', state: 1, time: '2023-10-19 14:00', img: 'https://cdn.uviewui.com/uview/goods/5.jpg', title: "关于uView的取名来由，首字母u来自于uni-app首字母，uni-app是基Vuejs，Vue和View(延伸为UI、视图之意)同音，同时view组件uni-app中最础最重要的组件，故取名uView，表达源于uni-app和Vue之意，同时在此也对它示感谢。", },

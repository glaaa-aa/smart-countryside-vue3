...
//    int  TOKEN_EXPIRE_TIME  = 3600;
 ...
 String CACHE_REL_FIELD_OLD_VAL = "sys:cache:desform:relFieldOldVal:";
   ...
   //update-end---author:scott ---date::2023-09-10  for：积木报表常量----
     ...
     * 评分类别：1：加分
     */
    String SCORE_TYPE_PLUS = "1";
    /**
     * 评分类别：2：扣分
     */
    String SCORE_TYPE_REDUCE = "2";
    /**
     * 按每年评分1次
     */
    String FOR_EVERY_YEAR = "A01";
    /**
     * 按每季度评分1次
     */
    String FOR_EVERY_QUARTER = "A02";// 按每季度评分1次
    /**
     * 按每月评分1次
     */
    String FOR_EVERY_MONTH = "A03";// 按每月评分1次
    /**
     * 按每天评分1次
     */
    String FOR_EVERY_DAY = "A04";// 按每天评分1次
    /**
     * 按单次评分
     */
    String FOR_EVERY_TIMES = "A05";// 按单次评分
    /**
     * 按不同级别情况评分
     */
    String FOR_DIFFERENT_LEVEL = "A06";// 按不同级别情况评分
    /**
     * 默认基础分
     */
    String FOR_BASE_SCORE = "A07";// 按默认基础分评分
    /**
     * 总积分
     */
    String FOR_TOTAL_SCORE = "A08";// 总积分

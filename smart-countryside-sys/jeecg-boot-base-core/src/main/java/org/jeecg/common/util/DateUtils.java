...
public class DateUtils extends PropertyEditorSupport {
    ...
    public static ThreadLocal<SimpleDateFormat> date_moeal = new ThreadLocal<SimpleDateFormat>() {
        @Override
        protected SimpleDateFormat initialValue() {
    ...
    public static ThreadLocal<SimpleDateFormat> yyyy= new ThreadLocal<SimpleDateFormat>() {
        @Override
        protected SimpleDateFormat initialValue() {
    ...
    //当前时间增加几个小时
    public  static  String getAddTime(Integer shu){
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        Calendar cal = Calendar.getInstance();
        cal.setTime(new Date());
        cal.roll(Calendar.HOUR, shu);// 24小时制
     ...
     * @return 默认日期按“年-月-日“格式显示
     */
    public static String formatMoonDate() {
        return date_moeal.get().format(getCalendar().getTime());
    }
    ...
    public static String formatYear() {
        return yyyy.get().format(getCalendar().getTime());
    }
     ...
     * @return
     */
    public static java.util.Date addHour(java.util.Date date, long l){
        long oldD = date.getTime();
        long deltaD = l * 60L * 60L * 1000L;
        long newD = oldD + deltaD;
        java.util.Date d = new java.util.Date(newD);
        return d;
    }
     ...
     * @return
     */
    public static java.util.Date addMinute(java.util.Date date, long l)	{
        long oldD = date.getTime();
    ...
    /**
     * 获取当前时间减多少月 返回数据格式  19997-01
     * Author:尹雄江
     * @param shu  1
     * @return
     */
    public  static  String getReduceMonth(Integer shu){
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        Calendar cal = Calendar.getInstance();
        cal.setTime(new Date());
    ...
    /**
     * 获取当前时间减多少月  不包含当前月 返回数据格式  19997-01
     * Author:尹雄江
     * @param intervals      intervals天内
     * @return              日期数组
     */
    public static ArrayList<String> getReduceMonthList(int intervals) {
        ArrayList<String> pastDaysList = new ArrayList<>();
        for (int i = intervals; i > 0; i--) {
            pastDaysList.add(getReduceMonth(i));
        }
        return pastDaysList;
    }
    ...
    /**
     * 获取当前时间减多少月  包含当前月 返回数据格式  19997-01
     * Author:尹雄江
     * @param intervals      intervals天内
     * @return              日期数组
     */
    public static ArrayList<String> getReduceMonthListDq(int intervals) {
        ArrayList<String> pastDaysList = new ArrayList<>();

...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/sys/thirdApp/**", "anon"); //第三方小程序登录


        filterChainDefinitionMap.put("/api/surveyDesign/**", "anon"); //智能表单先开放对外接口
        ...
        filterChainDefinitionMap.put("/apiCms/cms/section/list", "anon");

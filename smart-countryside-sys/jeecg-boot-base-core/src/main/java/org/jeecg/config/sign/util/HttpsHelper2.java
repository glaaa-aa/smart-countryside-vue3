...
public class HttpsHelper2 {
    ...
    public static String Post2(String urlString, Map<String, String> headers,  String content) {
        return HttpsGo(urlString, METHOD_POST, headers, content.getBytes(DEF_CHARSET), DEF_CONNECT_TIMEOUT, DEF_READ_TIMEOUT);
    }

    public static String Put(String urlString, Map<String, String> headers,  String content) {
        return HttpsGo(urlString, "PUT", headers, content.getBytes(DEF_CHARSET), DEF_CONNECT_TIMEOUT, DEF_READ_TIMEOUT);
    }

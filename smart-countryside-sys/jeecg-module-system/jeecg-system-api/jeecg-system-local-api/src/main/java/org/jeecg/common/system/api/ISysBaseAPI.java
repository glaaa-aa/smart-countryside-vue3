...
public interface ISysBaseAPI extends CommonAPI {
     ...
     * @return
     */
    List<LoginUser> getUserByTenantId(Integer tenantId);

    /**
     *  使用系统的编码规则
     * @param ruleCode 编码规则的code
     * @param formData 参数
     * @return
     */
    public  Object executeRule(String ruleCode, JSONObject formData);

    List<LoginUser> getUserByDepId(@Param("departId") String departId, @Param("username") String username);
     ...
     * @return
     */
    SysDepartModel getDepartByCode(String orgCode);

    /**
     * 根据用户真实姓名反查用户
     */
    List<LoginUser> queryUsersByRealname(String[] realnames);
     ...
     * @return
     */
    LoginUser queryByThirdId(String thirdUserId,String thirdType);


    LoginUser queryByCustomParams(QueryWrapper wrapper);
     ...
     */
    void saveUser(LoginUser user, String selectedRoles, String selectedDeparts);

    void editUser(LoginUser user);

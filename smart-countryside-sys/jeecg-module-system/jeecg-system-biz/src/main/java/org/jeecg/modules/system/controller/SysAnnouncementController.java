...
public class SysAnnouncementController {
	...
	@Autowired
    ThirdAppModuleService thirdAppModuleService;
	@Autowired
		...
		if(sysAnnouncement==null) {
			...
			if(ok) {
				...
				try {
					...
					Response<String> dtResponse = thirdAppModuleService.sendActionCardMessage(sysAnnouncement, false, tenantId);
					thirdAppModuleService.sendTextCardMessage(sysAnnouncement, true,tenantId);
		...
		if(sysAnnouncement==null) {
			...
			if(ok) {
				...
				if (oConvertUtils.isNotEmpty(sysAnnouncement.getDtTaskId())) {
					try {
//						thirdAppModuleService.recallMessage(sysAnnouncement.getDtTaskId());
					} catch (Exception e) {

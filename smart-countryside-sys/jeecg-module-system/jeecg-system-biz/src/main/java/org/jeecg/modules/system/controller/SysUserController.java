...
public class SysUserController {
	...
	public Result<SysUser> add(@RequestBody JSONObject jsonObject) {
		...
		try {
            ...
            user.setRelTenantIds(loginUser.getRelTenantIds());
            ...
            SysOrg sysOrg = orgService.queryByCode(user.getDistrictCode());
            hrPerson.setPersonNo(user.getUsername());

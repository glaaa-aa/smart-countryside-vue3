...
public interface SysDepartMapper extends BaseMapper<SysDepart> {
	...
	@Select("select * from sys_depart where dingtalk_identifier = #{dingtalkIdentifier}")
	public SysDepart queryByDingtalk(@Param("dingtalkIdentifier") String dingtalkIdentifier);
	 ...
	 * @return
	 */
	@Select("SELECT * FROM sys_depart where org_code = #{orgCode,jdbcType=VARCHAR}")
	SysDepart queryByOrgCode(@Param("orgCode")String orgCode);
	 ...
	 * @return
	 */
	public List<SysDepart> queryFenguanDepartByUser(@Param("userName")String userName);
	 ...
	 * @return
	 */
	@Update("update sys_depart set fenguan_leader = #{fenGuan} where id = #{id}")
	public int updateFenGuanById(@Param("fenGuan")String fenGuan, @Param("id")String id);
}

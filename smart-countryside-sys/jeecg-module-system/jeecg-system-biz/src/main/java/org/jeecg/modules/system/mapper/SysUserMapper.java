...
public interface SysUserMapper extends BaseMapper<SysUser> {
	...
	@Select("select u.id,u.username,u.realname,u.sex,u.phone,p.name as post from sys_user u left join sys_position p " +
			"on u.post = p.code ${ew.customSqlSegment}")
	List<SysUser> queryPositionsByRealname(@Param(Constants.WRAPPER) Wrapper wrapper);
}

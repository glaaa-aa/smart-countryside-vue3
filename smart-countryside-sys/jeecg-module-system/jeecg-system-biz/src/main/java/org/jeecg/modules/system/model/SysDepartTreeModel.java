...
public class SysDepartTreeModel implements Serializable{
    ...
    private String fenguanLeader; //分管领导账号
	...
	public SysDepartTreeModel(SysDepart sysDepart) {
        ...
        this.fenguanLeader = sysDepart.getFenguanLeader();
    ...
    public String getFenguanLeader() {
        return fenguanLeader;
    }

    public void setFenguanLeader(String fenguanLeader) {
        this.fenguanLeader = fenguanLeader;
    }

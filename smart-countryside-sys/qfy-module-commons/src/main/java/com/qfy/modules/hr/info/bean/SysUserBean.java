package com.qfy.modules.hr.info.bean;
...
public class SysUserBean {
    ...
    @Dict(dictTable ="qfy_system_dict",dicText = "item_text",dicCode = "item_value")
    ...
    //用户类型 1:平台管理员  3.企业管理员
    private Integer userType;

    private String colorCode;

    private Integer sortOrder; //排序 序号越大 越靠前
    private Integer tenantId;

    @Excel(name="管辖行政区划编码",width = 15)

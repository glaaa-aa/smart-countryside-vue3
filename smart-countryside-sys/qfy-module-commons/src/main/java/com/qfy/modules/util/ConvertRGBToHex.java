...
public class ConvertRGBToHex {
    ...
    public static String rgb() {
        ...
        //生成rgb的三个随机数
        int r = random.nextInt(256); // 生成第一个随机整数，范围在 0 到 255
        int g = random.nextInt(256); // 生成第二个随机整数，范围在 0 到 255
        int b = random.nextInt(256); // 生成第三个随机整数，范围在 0 到 255

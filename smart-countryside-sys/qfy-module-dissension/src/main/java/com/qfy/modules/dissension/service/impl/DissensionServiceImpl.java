 ...
 */
@Service
public class DissensionServiceImpl extends ServiceImpl<DissensionMapper, Dissension> implements IDissensionService {
...
//		moLog.setOptId(dissension.getRespPersons());
    ...
    @Override
    public Map<String, Object> queryDissensionCount(String state) {
        return dissensionMapper.queryDissensionCount(state);
    }
}

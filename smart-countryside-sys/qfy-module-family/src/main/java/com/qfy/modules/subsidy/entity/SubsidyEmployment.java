 ...
 */
@Data
@TableName("qfy_family_subsidy_employment")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="qfy_family_subsidy_employment对象", description="就业扶持信息表")
public class SubsidyEmployment extends BaseEntity implements Serializable {

 ...
 */
@Data
@TableName("qfy_family_subsidy_finance")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="qfy_family_subsidy_finance对象", description="医疗信息表")
public class SubsidyFinance extends BaseEntity implements Serializable {

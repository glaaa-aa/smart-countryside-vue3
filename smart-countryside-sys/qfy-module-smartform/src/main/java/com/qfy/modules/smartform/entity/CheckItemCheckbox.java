 ...
 */
@Data
@TableName("qfy_check_item_checkbox")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="qfy_check_item_checkbox对象", description="多选填空题")
public class CheckItemCheckbox extends BaseEntity implements Serializable {

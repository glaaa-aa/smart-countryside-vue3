 ...
 */
@Data
@TableName("qfy_check_item_multi_fillblank")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="qfy_check_item_multi_fillblank对象", description="多项填空题")
public class CheckItemMultiFillblank extends BaseEntity implements Serializable {

 ...
 */
@Data
@TableName("qfy_check_item_orderby")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="qfy_check_item_orderby对象", description="排序题")
public class CheckItemOrderby extends BaseEntity implements Serializable {

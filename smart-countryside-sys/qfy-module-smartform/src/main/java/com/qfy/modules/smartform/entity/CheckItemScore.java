 ...
 */
@Data
@TableName("qfy_check_item_score")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="qfy_check_item_score对象", description="评分题 行选项")
public class CheckItemScore extends BaseEntity implements Serializable {

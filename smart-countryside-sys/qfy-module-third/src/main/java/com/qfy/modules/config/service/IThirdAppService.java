...
public interface IThirdAppService {
     ...
     * @return 成功返回true
     */
    SyncInfoVo syncLocalDepartmentToThirdApp(String ids,Integer tenantId);
     ...
     * @return 成功返回true
     */
    SyncInfoVo syncThirdAppDepartmentToLocal(String ids,Integer tenantId);
     ...
     */
    SyncInfoVo syncLocalUserToThirdApp(String ids,Integer tenantId);
     ...
     * @return 成功返回空数组，失败返回错误信息
     */
    SyncInfoVo syncThirdAppUserToLocal(Integer tenantId,String ids);
     ...
     */
    int removeThirdAppUser(List<String> userIdList,Integer tenantId);

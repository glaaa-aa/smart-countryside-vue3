package com.qfy.modules.dingtalk.vo.thirdapp;
...
public class JdtDepartmentTreeVo extends Department {
    ...
    public static JdtDepartmentTreeVo getTopParent(List<Department> allDepartment) {
        // 先找出所有的父级
        for (Department department : allDepartment){
            if(department.getDept_id() == 1){
                JdtDepartmentTreeVo  vo = new JdtDepartmentTreeVo(department);
                return vo;
            }
        }
        return null;

...
import JSelectCheckItem from './jeecg/components/JSelectCheckItem.vue';
import JSelectCheckPosition from './jeecg/components/JSelectCheckPosition.vue';
import JSelectFamilyMember  from './jeecg/components/JSelectFamilyMember.vue';
import JSelectHrPerson  from './jeecg/components/JSelectHrPerson.vue';
...
componentMap.set('JSelectFamilyMember', JSelectFamilyMember);
componentMap.set('JSelectHrPerson', JSelectHrPerson);
componentMap.set('JSelectCheckItem', JSelectCheckItem);
componentMap.set('JSelectCheckPosition', JSelectCheckPosition);

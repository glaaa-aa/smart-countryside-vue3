...
<template>
  <div>
    ...
    <CheckItemSelectModel :rowKey="rowKey" @register="regModal" @getSelectResult="setValue" v-bind="getBindValue" :excludeUserIdList="excludeUserIdList"></CheckItemSelectModel>
  </div>
</template>
<script lang="ts">
import { unref } from 'vue';
import CheckItemSelectModel from './modal/CheckItemSelectModel.vue';

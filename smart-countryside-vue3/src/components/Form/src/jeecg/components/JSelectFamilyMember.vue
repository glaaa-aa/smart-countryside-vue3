...
<template>
  <div>
    ...
    <MemberListModal :rowKey="rowKey" @register="regModal" @getSelectResult="setValue" v-bind="getBindValue" :excludeUserIdList="excludeUserIdList"></MemberListModal>
  </div>
</template>
<script lang="ts">
import { unref } from 'vue';
import MemberListModal from './modal/FamilyMemberSelectModal.vue';
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    watch(()=>props.excludeUserIdList,(data)=>{
      console.log('excludeUserIdList=====>',excludeUserIdList)

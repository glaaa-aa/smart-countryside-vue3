...
<template>
  <div>
    ...
    <HrPersonModel :rowKey="rowKey" @register="regModal" @getSelectResult="setValue" v-bind="getBindValue" :excludeUserIdList="excludeUserIdList"></HrPersonModel>
  </div>
</template>
<script lang="ts">
import { unref } from 'vue';
import HrPersonModel from './modal/HrPersonModel.vue';

<template>
  <div>
    ...
    <!--字典弹窗-->
    <CmsSectionModal @register="registerModal" @success="handleSuccess"/>
  </div>
</template>

<script lang="ts" name="cms-cmsSection" setup>
  //ts语法
  import {ref, computed, unref, toRaw, nextTick} from 'vue';
  import {BasicTable, TableAction} from '/@/components/Table';
  import {useModal} from '/@/components/Modal';
  import { useListPage } from '/@/hooks/system/useListPage'
  import CmsSectionModal from './components/CmsSectionModal.vue';
  import {columns,searchFormSchema} from './CmsSection.data';
  import { downloadFile } from '/@/utils/common/renderUtils';
  import {list, deleteCmsSection, batchDeleteCmsSection, getExportUrl,getImportUrl, getChildList,getChildListBatch} from './CmsSection.api';
  ...
  async function handleDelete(record) {
    await deleteCmsSection({id: record.id}, importSuccess);
  }
  ...
  async function batchHandleDelete() {
    ...
    await batchDeleteCmsSection({id: ids}, importSuccess);
  }
  /**
   * 导入
   */

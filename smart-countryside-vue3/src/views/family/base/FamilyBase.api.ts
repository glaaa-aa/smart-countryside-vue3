...
enum Api {
  ...
  save='/family/familyBase/addBase',
  edit='/family/familyBase/addBase',
  ...
  // batchUpdateUrl = '/family/familyBase/batchUpdate',
}
/**
 * 导出api
 * @param params
 ...
 * 更新导入api
 */
// export const getBatchUpdateUrl = Api.batchUpdateUrl;
/**
 * 导入api
 */

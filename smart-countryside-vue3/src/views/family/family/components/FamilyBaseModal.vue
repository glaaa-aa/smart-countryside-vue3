<template>
  <BasicModal v-bind="$attrs" @register="registerModal" :title="title" :width="1024" @ok="handleSubmit">
    <family-base-form ref="formComponent" :formDisabled="formDisabled" :formBpm="false" @success="submitSuccess"></family-base-form>
  </BasicModal>
</template>
...
<script lang="ts">
  ...
  import FamilyBaseForm from './FamilyBaseForm.vue';

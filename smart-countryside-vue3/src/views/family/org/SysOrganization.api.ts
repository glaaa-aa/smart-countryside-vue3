...
enum Api {
  list = '/family/sysOrg/rootList',
  save='/family/sysOrg/add',
  edit='/family/sysOrg/edit',
  deleteSysOrganization = '/family/sysOrg/delete',
  deleteBatch = '/family/sysOrg/deleteBatch',
  importExcel = '/family/sysOrg/importExcel',
  exportXls = '/family/sysOrg/exportXls',
  loadTreeData = '/family/sysOrg/loadTreeRoot',
  getChildList = '/family/sysOrg/childList',
  getChildListBatch = '/family/sysOrg/getChildListBatch',
}

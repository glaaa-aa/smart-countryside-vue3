<template>
  <BasicModal v-bind="$attrs" @register="registerModal" destroyOnClose :width="500" :height="400" :title="getTitle" @ok="handleSubmit">
...
<script lang="ts" setup>
  ...
  import {formSchema} from '../SysOrganization.data';

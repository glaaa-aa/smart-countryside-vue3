...
export const formSchema: FormSchema[] = [
  ...
  // },
  {
    ...
    componentProps: ({ formModel }) => {
      return {
        options: [
          { label: '平台管理员', value: 1, key: '1' },
          { label: '企业管理员', value: 2, key: '2' },
        ],
        // onChange: () => {
  ...
  },
  {
    ...
    componentProps: ({ formModel }) => {
      return {
        options: [
          { label: '查询所有', value: 10, key: '1' },
          { label: '查询分管部门数据', value: 20, key: '2' },
          { label: '查询部门及其下级数据', value: 40, key: '3' },
          { label: '查询本部门数据', value: 50, key: '4' },
          { label: '查询个人数据', value: 60, key: '5' },
        ],
        // onChange: () => {
        //   formModel.userIdentity == 1 && (formModel.departIds = []);
        // },
